            ...
            <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-[#A0A0A0] text-sm md:text-[15px] leading-6">
                            {description}
                        </p>
                    ...
                    >
                        ...
                        <motion.div
                             className={`absolute w-[300px] h-[317px] md:w-[472px] md:h-[500px] bg-[#111111] rounded-[32px] z-0`}
                             style={{
                        ...
                        {/* Main Mockup Card */}
                        <motion.div
                            className="relative w-full h-[405px] md:h-[637px] bg-[#111111] rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] border border-[rgba(255,255,255,0.05)] z-10 overflow-hidden"
                            initial={{ y: reverseLayout ? 0 : 0 }}
                            whileInView={{ y: reverseLayout ? 20 : 30 }}
                        ...
                        >
                            <div className="p-0 h-full">
                                ...
                                >
                                    {/* Primary Image */}
                                    <div
                                        className="w-full h-full bg-cover bg-center rounded-[32px]"
                                        style={{
