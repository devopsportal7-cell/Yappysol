...
const NewHeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-32 pb-24 overflow-hidden bg-black">
      ...
      <div
        className={cn(
          ...
          'bg-[radial-gradient(ellipse_at_center,rgba(246,201,69,0.1),transparent_50%)]',
          'blur-[30px] z-10',
        )}
      />

      {/* Hero Content - Layered above background */}
      <div className="container mx-auto max-w-6xl flex flex-col items-center justify-center text-center relative z-20">
        {/* Main Headline */}
